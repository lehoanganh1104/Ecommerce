...
public class SuccessMessage {
    ...
    public static final String ORDER_RETURNED = "Order returned successfully";
    public static final String ORDER_CANCELED = "Order canceled successfully";
    public static final String ORDER_PAID = "Order paid successfully";
